...
* Instead of representing large numbers this way 2000000, prefer using the scientific notation to avoid missing zeros and causing bugs. Ex: 2.3E8 or 2.3E-8 which means 2 * 10 ^ 6 or 2 * 10 ^ -6. E is an exponent. You can also use 2.8 * Math.pow(10, 8) to represent large numbers in a readable way. In Kotlin you can also use underscores like 2_000_000.
...
CODE APPEARANCE
* To move methods up n down: ctrl + shift + up or down
* To move lines up n down: alt + shift + up or down
